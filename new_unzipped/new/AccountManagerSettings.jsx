...
export default function AccountManagerSettings() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("/v1/am/change-password", formDataToSend);
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-4">
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-purple-600 text-white py-2 px-4 rounded-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
